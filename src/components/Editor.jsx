...
function buildHTML(data, codFormApp) {
  ...
  // Placeholder vizibil pentru butonul Releasit
...
function addBlocks(editor, data) {
  ...
  // Helper - placeholder vizibil cu border rosu dashed
  function relBtn(extra) {
    return `<div class="unitone-releasit-btn" style="min-height:54px;display:block;border:2px dashed ${p};border-radius:6px;padding:6px;text-align:center;${extra || ''}"><span style="color:${p};font-size:12px;pointer-events:none;line-height:42px">&#128722; Buton COD - trage-ma unde vrei</span></div>`
  }
