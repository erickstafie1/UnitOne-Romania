...
<div style="padding:20px;background:#fff;border-top:1px solid #f3f4f6;border-bottom:3px solid #e8000d;text-align:center">
  ...
  <button class="_rsi-cod-form-pagefly-button-overwrite-v2" data-variant-id="VARIANT_ID" style="display:block;background:#e8000d;color:#fff;text-align:center;padding:16px 24px;border-radius:4px;font-size:18px;font-weight:900;text-decoration:none;letter-spacing:0.5px;margin-bottom:10px">COMANDĂ ACUM!</a>
...
<div style="padding:28px 20px;background:#f9fafb">
  ...
  <button class="_rsi-cod-form-pagefly-button-overwrite-v2" data-variant-id="VARIANT_ID" style="display:block;background:#e8000d;color:#fff;text-align:center;padding:14px;border-radius:4px;font-size:16px;font-weight:900;text-decoration:none;margin-top:20px">COMANDĂ ACUM!</a>
</div>
...
function addBlocks(editor, data) {
  ...
  const blocks = [
    ...
    { id:'button', label:'Button', cat:'Text', content:`<div style="padding:16px 20px;text-align:center"><button class="_rsi-cod-form-pagefly-button-overwrite-v2" data-variant-id="VARIANT_ID" style="display:inline-block;background:${p};color:#fff;padding:14px 32px;border-radius:6px;font-size:16px;font-weight:800;text-decoration:none;letter-spacing:0.5px">COMANDĂ ACUM!</a></div>` },
