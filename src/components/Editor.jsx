...
function buildHTML(data, codFormApp) {
  ...
  // Placeholder vizibil pentru butonul Releasit - rsi-cod-form-gempages-button-overwrite = injectare directa
  const relBtn = `<div class="unitone-releasit-btn rsi-cod-form-gempages-button-overwrite" style="min-height:54px;display:block;border:2px dashed ${primary};border-radius:6px;padding:6px;text-align:center;margin:8px 0"></div>`
...
function addBlocks(editor, data) {
  ...
  function relBtn(extra) {
    return `<div class="unitone-releasit-btn rsi-cod-form-gempages-button-overwrite" style="min-height:54px;display:block;border:2px dashed ${p};border-radius:6px;padding:6px;text-align:center;${extra || ''}"></div>`
  }
